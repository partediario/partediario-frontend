...
import { Calendar, Search, Filter, Download, User, ChevronDown, HelpCircle, X } from "lucide-react"
                ...
                <>
                  ...
                  <div className="absolute top-8 left-0 z-50 w-80 p-4 bg-white border border-gray-200 rounded-lg shadow-lg">
                    <div className="flex items-start justify-between mb-3">
                      <h4 className="font-semibold text-gray-900">Movimientos Recientes</h4>
                      <Button variant="ghost" size="sm" className="h-6 w-6 p-0" onClick={() => setShowTooltip(false)}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                    <div className="space-y-2 text-sm text-gray-600">
                      <p>Historial de los últimos movimientos de animales registrados.</p>
                      <div className="space-y-1">
                        <p>
                          <strong>• Entradas:</strong> Compras, nacimientos, traslados
                        </p>
                        <p>
                          <strong>• Salidas:</strong> Ventas, muertes, traslados
                        </p>
                        <p>
                          <strong>• Filtros:</strong> Por tipo, fecha y búsqueda
                        </p>
                        <p>
                          <strong>• Trazabilidad:</strong> Seguimiento completo de movimientos
                        </p>
                      </div>
                    </div>
                  </div>
