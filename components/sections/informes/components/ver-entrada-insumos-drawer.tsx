...
interface VerEntradaInsumosDrawerProps {
  isOpen: boolean
  onClose: () => void
  parte: ParteDiario
}
...
export default function VerEntradaInsumosDrawer({ isOpen, onClose, parte }: VerEntradaInsumosDrawerProps) {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onClose} direction="right">
      <DrawerContent className="h-full w-[850px] ml-auto" aria-describedby="ver-entrada-insumos-description">
        ...
        <div id="ver-entrada-insumos-description" className="sr-only">
          Visualizar los detalles de una entrada de insumos registrada
        </div>
