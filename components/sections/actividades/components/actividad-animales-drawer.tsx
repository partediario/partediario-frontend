...
interface CategoriaExistente {
  ...
  lote_id: number
  cantidad: number // Added for stock validation
}
...
interface ActividadAnimalesDrawerProps {
  isOpen?: boolean
  onClose?: () => void
  onSuccess?: () => void
...
export default function ActividadAnimalesDrawer({
  isOpen = false,
  onClose,
  onSuccess,
  actividadSeleccionada = null,
}: ActividadAnimalesDrawerProps) {
