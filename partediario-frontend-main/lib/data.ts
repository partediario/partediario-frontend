...
export const categoriasConfig: Record<string, CategoriaConfig> = {
  combustibles: {
    nombre: "Combustibles",
    emoji: "⛽",
    descripcion: "Gasoil, nafta y otros combustibles",
  },
  agroquimicos: {
    nombre: "Agroquímicos",
    emoji: "🌿",
    descripcion: "Herbicidas, insecticidas y fungicidas",
  },
  veterinarios: {
    nombre: "Veterinarios",
    emoji: "💉",
  ...
  sales: {
    nombre: "Sales y Fertilizantes",
    emoji: "🧂",
    descripcion: "Urea, fosfatos y otros fertilizantes",
  },
  semillas: {
    nombre: "Semillas",
    emoji: "🌱",
  ...
  repuestos: {
    nombre: "Repuestos",
    emoji: "🔧",
    descripcion: "Repuestos y herramientas",
  },
  balanceados: {
    nombre: "Balanceados",
    emoji: "🌾",
    descripcion: "Alimentos balanceados para ganado",
  },
  materiales: {
    nombre: "Materiales",
    emoji: "🏗️",
